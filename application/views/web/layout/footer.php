            ...
            <div class="footer-logo-wrap pt-50 pb-35">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <!--Footer da loja com informações-->
                        <ul class="des">
                            <?php $sistema = info_header_footer(); ?>
                            <li>
                                <span>Endereço: </span>
                                <?php echo $sistema->sistema_endereco . '&nbsp;' . 'Nº&nbsp;' . $sistema->sistema_numero; ?>
                            </li>
                            <li>
                                <span>Cidade: </span>
                            ...
                            <li>
                                <span>Telefones: </span>
                                <?php echo $sistema->sistema_telefone_fixo . '&nbsp' . '-&nbsp;' . $sistema->sistema_telefone_movel; ?>
                            </li>
                            <li>
                                <span>E-mail: </span>
